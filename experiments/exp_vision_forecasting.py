...
class Exp_Vision_Forecasting(Exp_Basic):
    def __init__(self, args, mean, std):
        super(Exp_Vision_Forecasting, self).__init__(args)
        self.args = args
    ...
    def _build_model(self):
        ...
        model.update_config(self.args.past_steps, self.args.future_steps, self.args.periodicity)
