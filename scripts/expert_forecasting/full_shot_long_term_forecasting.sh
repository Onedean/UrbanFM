...
do
    ...
    do
        for seed in "${seeds[@]}"
        do
            config_path="configs/expert_model/ts_model/${method}/${dataset}_full_shot_long_forecasting.json"
...
do
    ...
    do
        for seed in "${seeds[@]}"
        do
            config_path="configs/expert_model/st_model/${method}/${dataset}_full_shot_long_forecasting.json"
            echo "Running $method on $dataset with seed $seed"
            python expert_model_run.py --config "$config_path" --seed "$seed"
        done
    done
...
do
    ...
    do
        for seed in "${seeds[@]}"
        do
            config_path="configs/expert_model/stg_model/${method}/${dataset}_full_shot_long_forecasting.json"
            echo "Running $method on $dataset with seed $seed"
            python expert_model_run.py --config "$config_path" --seed "$seed"
        done
    done
...
do
    ...
    do
        for seed in "${seeds[@]}"
        do
            config_path="configs/expert_model/str_model/${method}/${dataset}_full_shot_long_forecasting.json"
            echo "Running $method on $dataset with seed $seed"
            python expert_model_run.py --config "$config_path" --seed "$seed"
        done
    done
